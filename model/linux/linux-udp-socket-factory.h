 ...
 */
#ifndef LINUX_UDP_SOCKET_FACTORY_H
#define LINUX_UDP_SOCKET_FACTORY_H
 ...
 * below.
 *
 * \see LinuxUdpSocketFactoryImpl
 */
class LinuxUdpSocketFactory : public SocketFactory
{
public:
...
#endif /* LINUX_UDP_SOCKET_FACTORY_H */
