 ...
 */
#ifndef LINUX_DCCP6_SOCKET_FACTORY_H
#define LINUX_DCCP6_SOCKET_FACTORY_H
 ...
 * below.
 *
 * \see LinuxDccp6SocketFactoryImpl
 */
class LinuxDccp6SocketFactory : public SocketFactory
{
public:
...
#endif /* LINUX_DCCP6_SOCKET_FACTORY_H */
