 ...
 */
#ifndef LINUX_DCCP_SOCKET_FACTORY_H
#define LINUX_DCCP_SOCKET_FACTORY_H
 ...
 * below.
 *
 * \see LinuxDccpSocketFactoryImpl
 */
class LinuxDccpSocketFactory : public SocketFactory
{
public:
...
#endif /* LINUX_DCCP_SOCKET_FACTORY_H */
