 ...
 */
#ifndef LINUX_DCCP_SOCKET_FACTORY_IMPL_H
#define LINUX_DCCP_SOCKET_FACTORY_IMPL_H
 ...
 */
class LinuxDccpSocketFactoryImpl : public LinuxDccpSocketFactory
{
public:
  /**
...
#endif /* LINUX_DCCP_SOCKET_FACTORY_IMPL_H */
