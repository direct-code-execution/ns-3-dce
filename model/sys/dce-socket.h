...
DCE(ssize_t, recvfrom , (int s, void *buf, size_t len, int flags,
                      struct sockaddr *from, socklen_t *fromlen));
DCE(ssize_t, recvmsg , (int s, struct msghdr *msg, int flags));
DCE(int, setsockopt , (int s, int level, int optname,
                    const void *optval, socklen_t optlen));
DCE(int, getsockopt , (int s, int level, int optname,
                    void *optval, socklen_t *optlen));
DCE(ssize_t, send , (int s, const void *buf, size_t len, int flags));
DCE(ssize_t, sendto , (int s, const void *buf, size_t len, int flags,
