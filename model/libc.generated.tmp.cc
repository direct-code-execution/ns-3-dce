...
decltype (clearerr)  __clearerr_unlocked __attribute__ ((weak, alias ("clearerr")));
        ...
        return ret;
             ...
             int sched_yield () noexcept {
                                    ...
                                    return dce_kill (__pid,__sig);
                                     ...
                                     int pthread_create (__restrict__ ::pthread_t * __newthread,__restrict__ ::pthread_attr_t const * __attr,void * (*__start_routine)( void * ) ,__restrict__ void * __arg) noexcept {
 ...
 void * pthread_getspecific (pthread_key_t __key) noexcept {
                                    ...
                                    return dce_pthread_setspecific (__key,__pointer);
                                     ...
                                     int pthread_key_create (pthread_key_t * __key,void (*__destr_function)( void * ) ) noexcept {
        ...
        return ret;
             ...
             int * __errno_location () noexcept {
                                    ...
                                    return dce___vsnprintf_chk (__s,__n,__flag,__slen,__format,__ap);
                                     ...
                                     int __xstat (int __ver,char const * __filename,struct stat * __stat_buf) noexcept {
                                    return dce___xstat (__ver,__filename,__stat_buf);
                                    }
                                     int __lxstat (int __ver,char const * __filename,struct stat * __stat_buf) noexcept {
                                    return dce___lxstat (__ver,__filename,__stat_buf);
                                    }
                                     int __fxstat (int __ver,int __fildes,struct stat * __stat_buf) noexcept {
                                    return dce___fxstat (__ver,__fildes,__stat_buf);
                                    }
                                     int __xstat64 (int __ver,char const * __filename,struct stat64 * __stat_buf) noexcept {
                                    return dce___xstat64 (__ver,__filename,__stat_buf);
                                    }
                                     int __lxstat64 (int __ver,char const * __filename,struct stat64 * __stat_buf) noexcept {
                                    return dce___lxstat64 (__ver,__filename,__stat_buf);
                                    }
                                     int __fxstat64 (int __ver,int __fildes,struct stat64 * __stat_buf) noexcept {
                                    return dce___fxstat64 (__ver,__fildes,__stat_buf);
                                    }
                                     int __fxstatat (int __ver,int __fildes,char const * __filename,struct stat * __stat_buf,int __flag) noexcept {
