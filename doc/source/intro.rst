...
DCE version 1.11 is the last release for Ubuntu 16.04, and is compatible with 
the `ns-3.34 release <https://www.nsnam.org/releases/ns-3-34/>`_.  The (optional) Linux kernel version
supported is 4.4 `(net-next-nuse-4.4.0) <https://github.com/libos-nuse/net-next-nuse/releases/tag/libos-v4.4>`_.

DCE version 1.12 is planned for use on Ubuntu 20.04 but with minimal changes from release 1.11.

Future versions of DCE are expected to update the Linux kernel version and support other Linux distributions.
